...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
  ...
  <form name="registerform" id="registerform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'register' ); ?>" method="post">
    ...
    <div id='signupForm3' class="loginForm circle center-parent hide-right">
    ...
    <div id='signupForm4' class="loginForm circle center-parent hide-right">
    ...
    <div id='signupForm5' class="loginForm circle center-parent hide-right">
